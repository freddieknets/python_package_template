...
# copyright ############################### #
# This file is part of the %package_name_capt% package.   #
...
for file in pyproject.toml gh.py release.py make_release_branch.py rename_release_branch.py LICENSE install_protection_hook.sh %package_name%/general.py
do
